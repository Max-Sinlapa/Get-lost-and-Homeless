...
public class TestTweening1 : MonoBehaviour
{
    ...
    [Header("Title")]
    [SerializeField] private Image Play = default;
    ...
    public void TestTweeningSequence()
    {
        DOTween.Sequence()
            ...
            //-------------------------------------------------------------
            .Insert(1.25f, star[1].DOFade(1, 0.25f).SetEase(Ease.InCubic))
            ...
            //---------------------------------------------------------------
            .Insert(0.25f, Play.DOFade(1, 0.5f).SetEase(Ease.InQuart))
            .Join(Play.rectTransform.DOScale(Vector3.one, 1f).SetEase(Ease.InOutBounce))
    ...
    private void OnStartSequence()
    {
        ...
        Play.rectTransform.localScale = Vector3.zero;
        Play.color = alphaZero;
